<div class="panel">
    ...
    <div class="panel-body">
        <div class="form-group">
            ...
            <input type="text" value="{!! clean($translation->title) !!}" placeholder="{{ __('Name of the space') }}" name="title"
                class="form-control">
        </div>
        <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="number" value="{{ $row->bed }}" placeholder="{{ __('Example: 3') }}"
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="number" value="{{ $row->bathroom }}" placeholder="{{ __('Example: 4') }}"
                            name="bathroom" class="form-control">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label>{{ __('Square') }} (m<span style="vertical-align: super; font-size: smaller;">2</span>)</label>
                        <input type="number" value="{{ $row->square }}" placeholder="{{ __('Example: 100') }}"
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="min_day_before_booking" class="form-control"
                                value="{{ $row->min_day_before_booking }}" placeholder="{{ __('Ex: 3') }}">
