...
<div class="item-loop {{ $wrap_class ?? '' }}">
    ...
    <div class="thumb-image p-0">
        ...
        <div id="slide-spacing-map-{{ $row->id }}" class="carousel slide h-100" data-interval="false">
            ...
            <button class="carousel-control-prev carousel-control" type="button" data-target="#slide-spacing-map-{{ $row->id }}" data-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="sr-only">Previous</span>
            </button>
            <button class="carousel-control-next carousel-control" type="button" data-target="#slide-spacing-map-{{ $row->id }}" data-slide="next">
        ...
        <div id="slide-spacing-{{ $row->id }}" class="carousel slide h-100" data-interval="false">
            ...
            <button class="carousel-control-prev carousel-control" type="button" data-target="#slide-spacing-{{ $row->id }}" data-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="sr-only">Previous</span>
            </button>
            <button class="carousel-control-next carousel-control" type="button" data-target="#slide-spacing-{{ $row->id }}" data-slide="next">
                <span class="carousel-control-next-icon" aria-hidden="true"></span>
                <span class="sr-only">Next</span>
            </button>
        </div>
    ...
    <div class="sale_info">{{ $row->contact }}</div>
    <div class="location">
